...
pitchviz <- function(pitchyear = "2015", team = "chn", pitchername = "Jake Arrieta") {
require(pitchRx)
require(dplyr)
...
png(paste0(pitchername,"_swing.png"), width=600)
print(p)
dev.off()
...
png(paste0(pitchername,"_take.png"), width=600)
print(c)
dev.off()
...
png(paste0(pitchername,"_foul.png"), width=600)
print(f)
dev.off()
...
png(paste0(pitchername,"_ball.png"), width=600)
print(h)
dev.off()
...
png(paste0(pitchername,"_outs.png"), width=600)
print(o)
dev.off()
...
h <- h + geom_point(size = 3, alpha = .65)
h <- h + theme(axis.title = element_text(size = 15, color = "black", face = "bold")) + theme(plot.title = element_text(size = 25, face = "bold", vjust = 1)) + theme(axis.text = element_text(size = 13, face = "bold", color = "black")) + theme(legend.title = element_text(size = 12)) + theme(legend.text = element_text(size = 12))
png(paste0(pitchername,"_hits.png"), width=600)
print(h)
dev.off()
...
png(paste0(pitchername,"_swingL.png"), width=600)
print(p_l)
dev.off()
...
png(paste0(pitchername,"_takeL.png"), width=600)
print(c_l)
dev.off()
...
png(paste0(pitchername,"_foulL.png"), width=600)
print(f_l)
dev.off()
...
png(paste0(pitchername,"_ballL.png"), width=600)
print(b_l)
dev.off()
...
png(paste0(pitchername,"_outsL.png"), width=600)
print(o_l)
dev.off()
...
png(paste0(pitchername,"_hitsL.png"), width=600)
print(h_l)
dev.off()
...
png(paste0(pitchername,"_swingR.png"), width=600)
print(p_r)
dev.off()
...
png(paste0(pitchername,"_takeR.png"), width=600)
print(c_r)
dev.off()
...
png(paste0(pitchername,"_foulR.png"), width=600)
print(f_r)
dev.off()
...
png(paste0(pitchername,"_ballR.png"), width=600)
print(b_r)
dev.off()
...
png(paste0(pitchername,"_outsR.png"), width=600)
print(o_r)
dev.off()
...
png(paste0(pitchername,"_hitsR.png"), width=600)
print(h_r)
dev.off()
